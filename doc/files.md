...
* bitcoinrent.conf: contains configuration settings for bitcoinrentd or bitcoinrent-qt
* bitcoinrentd.pid: stores the process id of bitcoinrentd while running
...
* debug.log: contains debug information and general logging generated by bitcoinrentd or bitcoinrent-qt
