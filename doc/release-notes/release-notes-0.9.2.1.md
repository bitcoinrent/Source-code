BitcoinRent Core version 0.9.2.1 is now available from:

  https://bitcoinrent.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTT to 0.01 BTT
...
- Fix "Start bitcoinrent on system login"
