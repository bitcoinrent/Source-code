Download URL: https://sourceforge.net/projects/bitcoinrent/files/BitcoinRent/bitcoinrent-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BTT fee schedule (users still pay 0.01 BTT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinrent00 - #bitcoinrent99
