BitcoinRent Core version 0.13.2 is now available from:

  <https://bitcoinrent.org/bin/bitcoinrent-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinrent-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinrent-tx to create v2 transactions (btcdrak)
