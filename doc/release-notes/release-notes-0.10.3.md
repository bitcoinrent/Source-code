BitcoinRent Core version 0.10.3 is now available from:

  <https://bitcoinrent.org/bin/bitcoinrent-core-0.10.3/>
...
(see https://github.com/bitcoinrent/bitcoinrent/pull/6793, as well as the 0.11.0
