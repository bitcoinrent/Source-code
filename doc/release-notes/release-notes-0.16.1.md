BitcoinRent Core version 0.16.1 is now available from:

  <https://bitcoinrentcore.org/bin/bitcoinrent-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitcoinrentd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitcoinrentd processes are cleaned up when tests end (sdaftuar)
