BitcoinRent-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinrent/files/BitcoinRent/bitcoinrent-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinRent
...
New/changed settings (command-line or bitcoinrent.conf file)
--------------------------------------------------------
