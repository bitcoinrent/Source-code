BitcoinRent Core version 0.10.4 is now available from:

  <https://bitcoinrent.org/bin/bitcoinrent-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinrent-tx into its own package
- #6953 `dfe0d4d` Include bitcoinrent-tx binary on Debian/Ubuntu
