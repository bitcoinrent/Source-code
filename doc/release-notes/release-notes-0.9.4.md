BitcoinRent Core version 0.9.4 is now available from:

  https://bitcoinrent.org/bin/0.9.4/
...
this update is incompatible with the BitcoinRent system and could lead to consensus
forks.

BitcoinRent Core released binaries from https://bitcoinrent.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinrent/+archive/ubuntu/bitcoinrent
- A third-party or self-compiled BitcoinRent Core

upgrade to BitcoinRent Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
