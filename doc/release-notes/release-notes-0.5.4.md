BitcoinRent version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinrent/files/BitcoinRent/bitcoinrent-0.5.4/
...
http://gitorious.org/bitcoinrent/bitcoinrentd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinRent-Qt notifications under Growl 1.3.
Increase required age of BitcoinRent-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinRent properly when installing BitcoinRent-Qt over it. (Windows)
