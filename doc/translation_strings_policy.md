...
This document provides guidelines for internationalization of the BitcoinRent Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinrent_en.ts` remains unchanged.
