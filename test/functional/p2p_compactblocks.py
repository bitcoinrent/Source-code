...
# TestP2PConn: A peer we use to send messages to bitcoinrentd, and store responses.
...
class CompactBlocksTest(BitcoinRentTestFramework):
    ...
    # This test actually causes bitcoinrentd to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinrentd's choice of nonce.
    ...
    # Test that bitcoinrentd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinrentd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinrentd will not send blocktxn responses for blocks whose height is
