...
"""Verify that starting bitcoinrent with -h works as expected."""

from test_framework.test_framework import BitcoinRentTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinRentTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinrent with -h for help text")
        ...
        self.log.info("Start bitcoinrent with -version for version information")
        ...
        self.log.info("Start bitcoinrentd with -fakearg to make sure it does not start")
