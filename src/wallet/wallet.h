...
#ifndef BITCOINRENT_WALLET_WALLET_H
#define BITCOINRENT_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinrent node, and set to 0 for transactions that were created
...
#endif // BITCOINRENT_WALLET_WALLET_H
