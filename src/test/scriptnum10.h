...
#ifndef BITCOINRENT_TEST_SCRIPTNUM10_H
#define BITCOINRENT_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from BitcoinRent Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINRENT_TEST_BIGNUM_H
