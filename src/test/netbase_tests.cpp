...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinrentcore.org", "www.bitcoinrentcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinrentcore.org]", "www.bitcoinrentcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinrentcore.org:80", "www.bitcoinrentcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinrentcore.org]:80", "www.bitcoinrentcore.org", 80));
