...
#ifndef BITCOINRENT_INTERFACES_NODE_H
#define BITCOINRENT_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinrent node (bitcoinrentd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOINRENT_INTERFACES_NODE_H
