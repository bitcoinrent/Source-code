#ifndef BITCOINRENT_CHAINPARAMSSEEDS_H
#define BITCOINRENT_CHAINPARAMSSEEDS_H
/**
 * List of fixed seed nodes for the bitcoinrent network
...
#endif // BITCOINRENT_CHAINPARAMSSEEDS_H
