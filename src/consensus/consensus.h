...
#ifndef BITCOINRENT_CONSENSUS_CONSENSUS_H
#define BITCOINRENT_CONSENSUS_CONSENSUS_H
...
// version. The former uses BitcoinRent parameters, but if this fork is a fork
...
#endif // BITCOINRENT_CONSENSUS_CONSENSUS_H
