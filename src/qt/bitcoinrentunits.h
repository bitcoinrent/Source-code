...
#ifndef BITCOINRENT_QT_BITCOINRENTUNITS_H
#define BITCOINRENT_QT_BITCOINRENTUNITS_H
...
/** BitcoinRent unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinRentUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinRentUnits(QObject* parent);

    /** BitcoinRent units.
      @note Source: https://en.bitcoinrent.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        BTT,
        mBTT,
...
typedef BitcoinRentUnits::Unit BitcoinRentUnit;

#endif // BITCOINRENT_QT_BITCOINRENTUNITS_H
