                                                                   ...
                                                                   mapper(0)
{
    ...
    ui->bitcoinrentAtStartup->setToolTip(ui->bitcoinrentAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcoinrentAtStartup->setText(ui->bitcoinrentAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBitcoinRentConfButton->setToolTip(ui->openBitcoinRentConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BitcoinRentUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinrentAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoinRentConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoinRentConf())
