...
static void SetupBitcoinRentTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoinrent-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  bitcoinrent-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoinrent transaction\n" +
                               "or:     bitcoinrent-tx [options] -create [commands]   Create hex-encoded bitcoinrent transaction\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinrent transaction
